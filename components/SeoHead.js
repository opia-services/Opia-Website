...
const defaultMeta = {
  title: 'Opia-services',
  siteName: 'Opia-services',
  description:
    'Opia-services agency for Filings, social media managenet and Massage therapy in Jamaica and across the globe ',
  // change base url of your web (without '/' at the end)
  url: 'https://Opia-services.vercel.app',
  type: 'website',
  robots: 'follow, index',
